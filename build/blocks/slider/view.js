...
/* harmony import */ var _wordpress_interactivity__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @wordpress/interactivity */ "@wordpress/interactivity");
/*
...
(0,_wordpress_interactivity__WEBPACK_IMPORTED_MODULE_3__.store)("cbb-slider-store", {
  callbacks: {
    onInit: () => {
      const context = (0,_wordpress_interactivity__WEBPACK_IMPORTED_MODULE_3__.getContext)();
      const swiperClass = `.cbb-swiper-${context.identifier}`;
      const paginationEnabled = (0,_wordpress_interactivity__WEBPACK_IMPORTED_MODULE_3__.getContext)().pagination;
      const paginationType = (0,_wordpress_interactivity__WEBPACK_IMPORTED_MODULE_3__.getContext)().paginationType;
      const autoplayEnabled = (0,_wordpress_interactivity__WEBPACK_IMPORTED_MODULE_3__.getContext)().autoPlayEnabled;
      const autoplayDelay = (0,_wordpress_interactivity__WEBPACK_IMPORTED_MODULE_3__.getContext)().autoplayDelay;
      const enableNavigationArrows = (0,_wordpress_interactivity__WEBPACK_IMPORTED_MODULE_3__.getContext)().enableNavigationArrows;
      const enableFadeEffect = (0,_wordpress_interactivity__WEBPACK_IMPORTED_MODULE_3__.getContext)().enableFadeEffect;
      const sliderEffect = (0,_wordpress_interactivity__WEBPACK_IMPORTED_MODULE_3__.getContext)().sliderEffect;
      ...
      // Load modules
      const navigationModules = enableNavigationArrows ? [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation] : [];
      const paginationModules = paginationEnabled ? [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination] : [];
      const autoplayModules = autoplayEnabled ? [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Autoplay] : [];
      const fadeEffectModule = sliderEffect === "fade" ? [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.EffectFade] : [];
      const coverflowEffectModule = sliderEffect === "coverflow" ? [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.EffectCoverflow] : [];

      // Slider creation
      const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(swiperClass, {
        cssMode: !(sliderEffect === "fade"),
        modules: [...navigationModules, ...paginationModules, ...autoplayModules, ...fadeEffectModule, ...coverflowEffectModule],
