				...
				<div className="cbb-editor__grid">
					<RangeControl
						...
						help={ sprintf(
							 ...
							 */
							__(
								'Please select the margin (%s) for the image.',
								'caledros-basic-blocks'
							),
							topUnit
						) }
					...
					<div className="cbb-editor__grid">
						<RangeControl
							...
							help={ sprintf(
								 ...
								 */
								__(
									'Please select the top margin (%s) for the image.',
									'caledros-basic-blocks'
								),
								topUnit
							) }
					...
					<div className="cbb-editor__grid">
						<RangeControl
							...
							help={ sprintf(
								 ...
								 */
								__(
									'Please select the right margin (%s) for the image.',
									'caledros-basic-blocks'
								),
								rightUnit
							) }
					...
					<div className="cbb-editor__grid">
						<RangeControl
							...
							help={ sprintf(
								 ...
								 */
								__(
									'Please select the bottom margin (%s) for the image.',
									'caledros-basic-blocks'
								),
								bottomUnit
							) }
					...
					<div className="cbb-editor__grid">
						<RangeControl
							...
							help={ sprintf(
								 ...
								 */
								__(
									'Please select the left margin (%s) for the image.',
									'caledros-basic-blocks'
								),
								leftUnit
							) }
