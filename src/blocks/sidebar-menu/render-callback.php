<?php
/**
 * Renders the content for the sidebar menu block
 *
...
/**
 * Render content for the sidebar menu block
 *
 * @param array $attributes List of block attributes defined in block.json.
...
function caledros_basic_blocks_sidebar_menu_render_cb( $attributes ) {
	...
	$open_button_styles_array = array( "height:$open_button_height", "gap:$open_button_gap" );
	...
	$close_button_styles_array = array( "width:$close_button_width", "height:$close_button_height", "--cbb-close-btn-bar-height:$close_button_bar_height", "--cbb-close-btn-bar-width:$close_button_bar_width", "--cbb-close-btn-bar-border-radius:$close_button_bar_border_radius" );

	// Add styles conditionally.
	if ( '0px' !== $close_button_border_width ) {
		$close_button_styles_array[] = "--cbb-close-btn-border-width:$close_button_border_width";
	}

	if ( '0px' !== $close_button_border_radius ) {
