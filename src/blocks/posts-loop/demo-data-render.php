<?php
/**
 * Renders the demo content for the post loop block
 *
...
/**
 * Render posts loop demo cards
 *
 * Renders the HTML markup of the individual demo cards of the
 * posts loop block.
 *
 * @param string $placeholder_url URL of the demo icon.
 * @param string $placeholder_background_url URL of the demo card image.
 * @param string $title Card's title.
 * @param string $date Card's date.
 *
 * @return void
 */
...
/**
 * Render posts loop demo content
 *
 * Renders the whole HTML markup for the demo content.
 *
 * @param string $placeholder_background_url URL of the demo card image.
 * @param string $placeholder_url URL of the demo icon.
 *
 * @return string HTML markup for the demo data.
 */
function caledros_basic_blocks_get_demo_data( $placeholder_background_url, $placeholder_url ) {
	$cards = array(
		array(
			'title' => 'Marketing Moves That Matter',
			'date'  => 'May 15, 2025',
		),
		array(
			'title' => 'What’s Working in 2025',
			'date'  => 'May 16, 2025',
		),
		array(
			'title' => 'Quick Wins for Smart Marketers',
			'date'  => 'May 16, 2025',
		),
		array(
			'title' => 'Trends to Watch this Quarter',
			'date'  => 'May 17, 2025',
		),
	);
