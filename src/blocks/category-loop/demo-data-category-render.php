<?php
/**
 * Loads the category loop block demo data
 *
...
/**
 * Load category loop block demo data
 *
 * The demo data is only visible when the "Show demo data" option is enabled.
 *
 * @param string $placeholder_background_url    Card body placeholder image URL.
 * @param string $placeholder_url               Header placeholder image URL.
 * @return string Buffered demo data content
 */
