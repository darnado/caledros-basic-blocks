...
export default function LightHoverColorSettings({ attributes, setAttributes }) {
  const { menuLightHoverColor } = attributes;
  ...
  return (
    <PanelBody
      title={__("Hover/active color (light mode)", "caledros-basic-blocks")}
      initialOpen={false}
    >
      <ColorPalette
