...
export default function DarkHoverColorSettings({ attributes, setAttributes }) {
  const { menuDarkHoverColor } = attributes;
  ...
  return (
    <PanelBody
      title={__("Hover/active color (dark mode)", "caledros-basic-blocks")}
      initialOpen={false}
    >
      <ColorPalette
