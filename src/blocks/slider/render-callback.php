<?php
/**
 * Renders the content for the slider block
 *
...
/**
 * Render the content for the slider block
 *
...
function caledros_basic_blocks_slider_render_cb( $attributes ) {
	...
	$wp_context_json = htmlspecialchars( wp_json_encode( $wp_context ), ENT_QUOTES, 'UTF-8' );
