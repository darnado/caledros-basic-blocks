...
export default function ButtonHoverTextLightColorSettings({
  attributes,
  setAttributes,
}) {
  const { buttonHoverTextLightColor } = attributes;
  ...
  return (
    <PanelBody
      title={__("Hover text color (Light mode)", "caledros-basic-blocks")}
      initialOpen={false}
    >
      <ToggleControl
