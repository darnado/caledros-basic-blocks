...
export default function ButtonHoverTextDarkColorSettings({
  attributes,
  setAttributes,
}) {
  const { buttonHoverTextDarkColor } = attributes;
  ...
  return (
    <PanelBody
      title={__("Hover text color (Dark mode)", "caledros-basic-blocks")}
      initialOpen={false}
    >
      <ToggleControl
