<?php
/**
 * Load JSON translation files if they exist
 *
 ...
 *
 * Such JSON files are only loaded if they exist in the languages folder.
 * This funcion makes the selected blocks' strings translation-ready. Also,
 * it only governs JS and block translations. Hooked to 'wp_enqueue_scripts'.
 *
 * @return void
 */
