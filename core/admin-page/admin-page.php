...
/**
 * Registers admin page settings.
 *
 * This function runs when an admin screen is initialized.
 *
 * @return void
 */
function caledros_basic_blocks_register_settings() {
	// CSS Preloader setting.
	$preload_args = array(
		'type'              => 'integer',
	...
	// 'Add column layout to wp_site_blocks' setting.
	...
	// 'Set 100vh height to wp site blocks' setting.
	$column_layout_args = array(
		'type'              => 'integer',
...
/**
 * CSS preloader sanitize callback.
 *
 * It saves '1' if the setting is checked. Otherwise, it saves '0'.
 * When this setting is checked, the CSS preloader is enabled.
 *
...
/**
 * 'Add column layout to wp_site_blocks' sanitize callback.
 *
 * It saves '1' if the setting is checked. Otherwise, it saves '0'.
 * When this setting is checked, the "flex-column" CSS property is added
 * to the "wp-site-blocks" container.
 *
 * @param string $input The option checkbox value.
 *
 * @return integer  The setting value ready to be registered.
...
/**
 * Set 'Set 100vh height to wp site blocks' sanitize callback.
 *
 * It saves '1' if the setting is checked. Otherwise, it saves '0'.
 * When this setting is checked, the height of the "wp-site-blocks" container
 * is set to 100vh.
 *
 * @param string $input The option checkbox value.
 *
 ...
 * Add admin page.
 *
 * Adds the plugin admin page to the WordPress dashboard sidebar.
 * The admin page is rendered at the sidebar's bottom, after Settings.
 *
 * @return void
 */
 ...
 *
 * Renders the content of the plugin admin page. Such contents include checkboxes for:
 * - Enabling the CSS preloader.
 * - Adding flex-column layout CSS property to the "wp-site-blocks" container
 * - Setting 100vh height to the "wp-site-blocks" container
 *
 * @return void
 */
